...
$stmt = $conn->prepare("INSERT INTO business_requests (individual_name, business_name, business_link, business_contact, promo_description, promo_date, additional_information) VALUES (?, ?, ?, ?, ?, ?, ?)");

$stmt->bind_param("sssssss", $iname, $bname, $blink, $bcontact, $bpromo, $date, $badditional);


if ($stmt->execute() === TRUE) {
  echo "Thanks for working with Sunrises - we'll reach out soon!";
} else {
