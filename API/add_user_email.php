...
$stmt = $conn->prepare("INSERT INTO users (name, updated_interests, updated_lft, today_alert, tomorrow_alert, darkmode, animations, premium, email, phone, hash) VALUES (?, ?, ?, '8', '20', '0', '1', '0', ?, 'EMAILLOGIN', ?)");

$stmt->bind_param("sssss", $name, $UPDATED_INTERESTS, $UPDATED_LFT, $email, $user_hash);
